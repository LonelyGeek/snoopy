    ...
    <thead> 
      ...
      <tfoot>
         <tr>
            ...
            <tr>
               <td colspan="5"><a href="orcamento.php?id=Orçamento"><button type="button" class="btn btn-primary"><< Voltar</button></td></a></td>
               <td colspan="5"><a href="caixa3o.php?id=Orçamento"><button type="button" class="btn btn-success">Continuar >></button></td></a></td>
      </tfoot>
