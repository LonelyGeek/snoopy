...
echo "<h2><font color='#095077'> Informações do Cliente:</font></h2>";

echo "<font size='4'><b>Nome:</b> ".$busca->nome."</font><br>";
echo "<font size='4'><b>Modelo do veículo:</b> ".$busca->modveiculo."</font><br>";
echo "<font size='4'><b>Placa:</b> ".$busca->placa."</font><br>";
echo "<font size='4'><b>Ano:</b> ".$busca->ano."</font><br>";
echo "<font size='4'><b>Endereço:</b> ".$busca->endereco."</font><br>";
...
<form action="final.php?id=Caixa" method="POST" class="form form-horizontal"> 
...
<h2><font color="#095077">Serviço: </font></h2>
...
<h2><font color="#095077">Observação: </font></h2>
