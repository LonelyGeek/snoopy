...
echo "<h2> Informa&ccedil&otildees do produto:</h2>";
...
echo "<br>";
echo '<a href="caixa2o.php?acao=add&id='.$noticia->id.'"><button type="button" class="btn btn-primary">Adicionar na lista</button></a>';
