     ...
     <thead>
      ...
      <tfoot>
         <tr>
            ...
            <tr>
               <td colspan="5"><a href="caixa3o.php?id=Caixa"><button type="button" class="btn btn-primary"><< Voltar</button></td></a></td>
               <td colspan="5"><a href="#"><button type="button" class="btn btn-success">Concluir venda >></button></td></a></td>
      </tfoot>
