  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card card-mini">
      <div class="card-header">
        <div class="card-title"><h1>Relatório de vendas do dia</h1> </div>
...
<a href="relatoriosemana.php?id=Relatório Semana"><button type="button" class="btn btn-primary">Relatório Semana</button></a> <a href="relatoriomes.php?id=Relatório do mês"><button type="button" class="btn btn-success">Relatório Mês</button></a>
</center>
