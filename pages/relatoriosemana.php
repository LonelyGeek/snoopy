  ...
  <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
    <div class="card card-mini">
      <div class="card-header">
        <div class="card-title"><h1>Relatório de vendas da semana
        </h1> </div>
...
<table class="datatable table table-striped primary" cellspacing="0" width="100%">
 ...
 $semana = date('Y-m-d');
               ...
               foreach($busca->selecionarVendaSemana($semana) as $linha){  
                ini_set( 'display_errors', 0 ); ?>
        <tr>
...
<a href="painel.php?id=Painel"><button type="button" class="btn btn-primary">Relatório Dia</button></a> <a href="relatoriomes.php?id=Relatório do Mês"><button type="button" class="btn btn-success">Relatório Mês</button></a>
</center>
